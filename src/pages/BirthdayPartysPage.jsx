...
const SCRIPT_URL = "https://script.googleusercontent.com/macros/echo?user_content_key=AehSKLherO7Z1qAscn35MztLJDfvDLvZcljMzYKHljTB2bLo6oYt3_qxdfU0O3AQOvm_fDHgYUybGEooIPh1AL8MZt7BJfQcn_nZKKfcFXg786AinUoJz-UUmptH0-xAq1Sp2gZqhhXdwVnhYppU_cee-03gwvYSHK-ERcmf5g5L8VQfaIA-uque8HYG6vni89yVeTlZGT17Rgg5F8SD6yYdkoc18x7varvea0SInwmQ11_BAuwSNEZR8HEBHpJAFnmG8C_RKrvoE9dGgFKLbef-RqtEL3kp83S1CWzwW5yy&lib=M8XqEU5PWHDwRSR80uVWxZdVZKDkicKz2";
      ...
      <header className="relative overflow-hidden pb-8 pt-8 text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <p className="mx-auto mt-4 max-w-xl font-body text-base font-light text-muted-foreground">
            Discover our curated collection of exquisite Birthday Partys inspirations
          </p>
